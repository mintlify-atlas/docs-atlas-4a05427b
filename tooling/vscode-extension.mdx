...
description: "Install and configure the hades-language VS Code extension to get syntax highlighting, bracket matching, and comment toggling for .hds and .hd files."
---
