...
<Steps>
  ...
  <Step title="Define and call a function">
    ...
    The example below defines a classic recursive Fibonacci sequence and a factorial function (taken directly from `testing.hds` in the repository), then prints the first ten values of each:
